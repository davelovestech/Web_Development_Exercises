...
b11 = Book.create(title: "This", author: "Author", description: "This is a description!", publisher: "This is a publisher!", weeks_on_list: 100, rank_this_week: 1)
b12 = Book.create(title: "Another", author: "Someone", description: "Description!!!!!!", publisher: "Penguin", weeks_on_list:11111, rank_this_week: 1)
...
Review.create(comment: "I have hands!", author: "Handy McHandersons", book_id: b11.id)
Review.create(comment: "This is an illusion.", author: "Buddha", book_id: b11.id)

Review.create(comment: "#Hashtag", author: "Twitter", book_id: b12.id)
Review.create(comment: "Just the number 7 ... it's lucky.", author: "Reality", book_id: b12.id)
