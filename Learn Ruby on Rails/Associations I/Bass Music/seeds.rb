...
a8 = Album.create(cover: "https://cdn.shopify.com/s/files/1/1103/6548/products/schwifty-mock-03.jpg?v=1480054373", title: "Get Schwifty", artist: "Rick and Morty")
Track.create(name: "Aww, jeez", minutes: 9, album_id: a8.id)
Track.create(name: "Wubba Lubba Dub Dub!", minutes: 3, album_id: a8.id)
Track.create(name: "Get Schwifty", minutes: 4, album_id: a8.id)
